...
type
  TIdi2dX509= function(x: Pointer; outx: Pointer): Integer cdecl; 

var
  IdSSLeayversion: function(vertype: Integer): PChar cdecl = nil;
  IdBIOnewfile: function(filename, mode: PChar): Pointer cdecl = nil;
  IdRSAgeneratekey: function(num: Integer; e: Cardinal; callback: Pointer; cb_arg: Pointer): Pointer cdecl = nil;
  IdBIOfree: function(bio: Pointer): Integer cdecl = nil;
  IdX509REQnew: function: Pointer cdecl = nil;
  IdRSAfree: procedure(rsa: Pointer) cdecl = nil;
  IdX509NAMEnew: function: Pointer cdecl = nil;
  IdX509REQfree: procedure(req: Pointer) cdecl = nil;
  IdX509NAMEENTRYcreatebytxt: function(ne: Pointer; field: PChar; ntype: Integer; name: PChar; namelen: Integer): Pointer cdecl = nil;
  IdX509NAMEfree: procedure(n: Pointer) cdecl = nil;
  IdX509NAMEaddentry: function(xn, xne: Pointer; nloc, nset: Integer): Integer cdecl = nil;
  IdX509REQsetsubjectname: function(xr, xn: Pointer): Integer cdecl = nil;
  IdEVPPKEYnew: function: Pointer cdecl = nil;
  IdEVPPKEYset1RSA: function(pkey, key: Pointer): Integer cdecl = nil;
  IdEVPPKEYfree: procedure(key: Pointer) cdecl = nil;
  IdX509REQsetpubkey: function(x, pkey: Pointer):Integer cdecl = nil;
  IdX509REQsign: function(x, pkey, md: Pointer): Integer cdecl = nil;
  IdEVPsha256: function: Pointer cdecl = nil;
  IdX509REQtoX509: function(r: Pointer; day: Integer; pkey: Pointer): Pointer cdecl = nil;
  IdX509free: procedure(a: Pointer) cdecl = nil;
//  IdPEMwritebioRSAPrivateKey
  Idi2dX509: TIdi2dX509 = nil;
//  IdPEMASN1writebio: function(i2d: TIdi2dX509; name: PChar; bp, x, enc, kstr: Pointer; klen: Integer; cb: Pointer): integer cdecl = nil;
  IdPEMwritebioRSAPrivateKey: function(bp, x, enc: Pointer; kstr: Pchar; klen: Integer; cb, u: Pointer): Integer cdecl = nil;
  IdPEMwritebioX509: function(bp, x: Pointer): integer cdecl = nil;
...
const
  ...
  fn_X509_NAME_ENTRY_create_by_txt = 'X509_NAME_ENTRY_create_by_txt';  {Do not localize}
...
begin
  ...
  if hIdCrypto = 0 then hIdCrypto := HMODULE(dlopen(PChar(ExtractFilePath(ParamStr(0))+SSLCLIB_DLL_name), RTLD_GLOBAL));
  if hIdCrypto = 0 then hIdCrypto := HMODULE(dlopen(SSLCLIB_DLL_name, RTLD_GLOBAL));
  If hIdSSL = 0 Then hIdSSL := HMODULE(dlopen(PChar(ExtractFilePath(ParamStr(0))+SSL_DLL_name), RTLD_GLOBAL));
  ...
  @IdSSLeayversion := LoadFunctionClib(fn_SSLeay_version);
  @IdBIOnewfile := LoadFunctionClib(fn_BIO_new_file);
  @IdRSAgeneratekey := LoadFunctionClib(fn_RSA_generate_key);
  @IdBIOfree := LoadFunctionClib(fn_BIO_free);
  @IdX509REQnew:= LoadFunctionClib(fn_X509_REQ_new);
  @IdRSAfree := LoadFunctionClib(fn_RSA_free);
  @IdX509NAMEnew:= LoadFunctionClib(fn_X509_NAME_new);
  @IdX509REQfree:= LoadFunctionClib(fn_X509_REQ_free);
  @IdX509NAMEENTRYcreatebytxt:= LoadFunctionClib(fn_X509_NAME_ENTRY_create_by_txt);
  @IdX509NAMEfree:= LoadFunctionClib(fn_X509_NAME_free);
  @IdX509NAMEaddentry:= LoadFunctionClib(fn_X509_NAME_add_entry);
  @IdX509REQsetsubjectname:= LoadFunctionClib(fn_X509_REQ_set_subject_name);
  @IdEVPPKEYnew:= LoadFunctionClib(fn_EVP_PKEY_new);
  @IdEVPPKEYset1RSA:= LoadFunctionClib(fn_EVP_PKEY_set1_RSA);
  @IdEVPPKEYfree:= LoadFunctionClib(fn_EVP_PKEY_free);
  @IdX509REQsetpubkey:= LoadFunctionClib(fn_X509_REQ_set_pubkey);
  @IdX509REQsign:= LoadFunctionClib(fn_X509_REQ_sign);
  @IdEVPsha256:= LoadFunctionClib(fn_EVP_sha256);
  @IdX509REQtoX509:= LoadFunctionClib(fn_X509_REQ_to_X509);
  @IdX509free:= LoadFunctionClib(fn_X509_free);
  @IdPEMwritebioX509:= LoadFunctionClib(fn_PEM_write_bio_X509);
  @IdPEMwritebioRSAPrivateKey:= LoadFunctionClib(fn_PEM_write_bio_RSAPrivateKey);
//ebben igazad van, mar evekkel korabban kellett volna
  ...
  *)
  ...
  result := (@IdSslNew<>nil) and (@IdSslFree<>nil) and (@IdSslRead<>nil) and (@IdSslWrite<>nil);
(*
  result:=
